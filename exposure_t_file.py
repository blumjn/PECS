def exposure_t(pattern,exposure_shape,col,row,a,b,n,pixel_size,beamstep,dose,exposure,threshold,t,nt):
    import numpy as np
    import math as m
    import config
...
#steps through the pattern and checks if it should expose the area
    ...
    config.exposed_map = config.exposed_map + exposure_shape
    return 